...
<VideoInputForm  onVideoUploaded={setVideoId}/>
    ...
    <div className='space-y-4'>
      ...
      <span className='block text-xs text-muted-foreground italic leading-relaxed'>Valores mais altos tendem deixar o resultado mais critativo e com possíveis erros.</span>
    </div>

    <Separator/>

    <Button type='submit' className='w-full' disabled={isLoading}>Executar <Wand2 className='w-4 h-4 ml-2'/></Button>
    </form>
